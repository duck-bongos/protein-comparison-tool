...
fn App() -> impl IntoView {
    ...
    view! {
        ...
        <p style="font-style: italic; display: block">"Compare different sources of protein, animal sources, plant sources, and supplements, by leanness or cost. You can compare online deals to in-store prices."</p>
